...
public class FunctionalitySelector {
    ...
    public void selectAndRun() {
        String[] options = { "All","Loan Deposit", "Cash Deposit","MoneyTransfer","SSS_PMJJBY","SSS_PMSBY","SSS_APY","ATM Card Block","ChequeBookRequest","Account Opening","Loan Deposit","ViewLoanDataCollection","Exit"};
